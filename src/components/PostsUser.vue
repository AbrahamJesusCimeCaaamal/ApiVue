<template>
    ...
    <div class="overflow-x-auto flex justify-center items-center">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mx-10">
            <div v-for="post in datos" :key="post.id" class="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div class="card-stats grid grid-cols-3 bg-lime-500 rounded-b-lg text-white text-lg font-bold">
