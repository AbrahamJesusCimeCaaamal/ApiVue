    ...
    <div class="  ">
        <div v-if="!mostrarContenido" class="">
            <div v-for="user in users" :key="user.id" class=" p-6">
                <div class=" bg-white border border-gray-200 rounded-lg shadow-lg p-6  bg-gradient-to-br  from-blue-400 via-purple-400 to-pink-300">
                    <div class="mb-4">
                        <div class="font-bold text-xl mb-2 text-center">{{ user.name }}</div>
                    ...
                    <div class="flex justify-center items-center">
                        <button @click="mostrarPublicaciones(user.id)"
                            class="bg-blue-500 hover:bg-blue-700 text-white items-center font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline-blue active:bg-blue-800">
                            Publicaciones
                        </button>
                    </div>
                </div>
